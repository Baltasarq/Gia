...
public class Direccion implements Raiz{
...
public void setPiso(String x)
{ piso = x; }

public String getLocaLidad() 
{ return localidad; }

public void setLocaLidad(String x)
{ localidad = x; }
...
public void setCpostal(int x)
{ cpostal = x; }

public int getPais() 
{ return pais; }

public void setPais(int x)
{ pais = x; }


public Direccion () {}
public String getClassName(){ return "Direccion";}

 public Vector getvAtb(){
   Vector salida = new Vector();
   salida.addElement("ident");  salida.addElement("calle");
  salida.addElement("numero");
  salida.addElement("piso");
  salida.addElement("localidad");
  salida.addElement("provincia");
  salida.addElement("cpostal");
  salida.addElement("pais");
 return salida;}
